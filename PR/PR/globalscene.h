...
public:
    ...
    void setVector3DData(QVector3D& vector, float x, float y, float z);
    ...
    void drawQuads(QVector<quadrangle>& quads, QImage& image, QPainter& painter, QMatrix4x4& matrix);

    bool static columnSort(const quadrangle& q1, const quadrangle& q2);
